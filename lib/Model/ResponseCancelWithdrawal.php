...
/**
 * ResponseCancelWithdrawal Class Doc Comment
 *
 * @category Class
 * @package  UniPayment\Client
 */
class ResponseCancelWithdrawal implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $modelName = 'ResponseCancelWithdrawal';
