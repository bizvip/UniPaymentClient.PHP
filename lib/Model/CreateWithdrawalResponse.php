...
/**
 * CreateWithdrawalResponse Class Doc Comment
 *
 * @category Class
 * @package  UniPayment\Client
 */
class CreateWithdrawalResponse implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $modelName = 'CreateWithdrawalResponse';
